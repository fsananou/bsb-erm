...
\subsection{Chap1}
\begin{frame}{Understanduing risk: financial risk}
    ...
    \begin{itemize}
        ...
        \end{itemize} 
           \medskip 
          \item [$\bullet$] In what situation does the bank profit fluctuate even if there is nothing wrong on its customers side ? 
          \begin{itemize}
...
\subsection{Chap1}
\subsection{Chap1}
\begin{frame}{Understanduing risk: measures}
...
\end{itemize}
\end{itemize}
 \href{https://github.com/fsananou/bsb-erm/blob/main/_exercice_and_cases.pdf}{\ovalbox{Practice}}
